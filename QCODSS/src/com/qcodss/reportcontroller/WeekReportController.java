...
public class WeekReportController {
	...
	public WeekReportController(int weekNo, int year, int plantID){
		this.weekNo = weekNo;
	...
	private double cal123EfficiencyNew(List<Style> allStyles){
		...
		if (allStyles.isEmpty() == false) {
			   for(Style style:allStyles){
				   ...
				   if(style.getNewRepeat().equals("n")){
					   clocked_123n = clocked_123n + style.getClockedHrs_1() + style.getClockedHrs_2() + style.getClockedHrs_3();
					   	
					   produced_123n = produced_123n + style.getProducedHrs_1()+style.getProducedHrs_2()+style.getProducedHrs_3() ;
				   }
	...
	private double cal123EfficiencyRepeat(List<Style> allStyles){
		...
		if (allStyles.isEmpty() == false) {
			   for(Style style:allStyles){
				   ...
				   if(style.getNewRepeat().equals("r")){
					   clocked_123r = clocked_123r + style.getClockedHrs_1() + style.getClockedHrs_2() + style.getClockedHrs_3();
						
					   produced_123r = produced_123r + style.getProducedHrs_1()+style.getProducedHrs_2()+style.getProducedHrs_3() ;
				   }
	...
	private double cal123EfficiencyAll(List<Style> allStyles){
		...
		if (allStyles.isEmpty() == false) {
			   for(Style style:allStyles){
				clocked_123 = clocked_123 + style.getClockedHrs_1()+ style.getClockedHrs_2() + style.getClockedHrs_3();

			    produced_123 = produced_123 + style.getProducedHrs_1()+style.getProducedHrs_2()+style.getProducedHrs_3() ;
	...
	private double calEPR123n(List<Style> allStyles){
		...
		if (allStyles.isEmpty() == false) {
			   for(Style style:allStyles){
				   ...
				   if(style.getNewRepeat().equals("n")){
					   FTTn = FTTn + style.getTotalFTT_1() + style.getTotalFTT_2() + style.getTotalFTT_3();
						
					   INSn = INSn + style.getTotalInspected_1() + style.getTotalInspected_2() + style.getTotalInspected_3() ;
				   }
	...
	private double calEPR123r(List<Style> allStyles){
		...
		if (allStyles.isEmpty() == false) {
			   for(Style style:allStyles){
				   ...
				   if(style.getNewRepeat().equals("r")){
					   FTTr = FTTr + style.getTotalFTT_1() + style.getTotalFTT_2() + style.getTotalFTT_3();
						
					   INSr = INSr + style.getTotalInspected_1() + style.getTotalInspected_2() + style.getTotalInspected_3() ;
				   }
	...
	private double calEPR123All(List<Style> allStyles){
		...
		if (allStyles.isEmpty() == false) {
			   ...
			   FTT = FTT + style.getTotalFTT_1() + style.getTotalFTT_2() + style.getTotalFTT_3();
				
			   INS = INS + style.getTotalInspected_1() + style.getTotalInspected_2() + style.getTotalInspected_3() ;
	...
	private double cal45EfficiencyAverage(List<Style> allStyles){
		...
		if (allStyles.isEmpty() == false) {
			   for(Style style:allStyles){
					   ...
					   clocked_45 = clocked_45 + style.getClockedHrs_4() + style.getClockedHrs_5() ;
					   	
					   produced_45 = produced_45 + style.getProducedHrs_4()+style.getProducedHrs_5();
